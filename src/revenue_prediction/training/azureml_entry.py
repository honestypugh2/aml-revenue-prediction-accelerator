...
locally:
    ...
    python -m revenue_prediction.training.azureml_entry --data data/synthetic/revenue_snapshots.parquet --output outputs/model
...
def main() -> None:
    ...
    from ..inference.predict import save_bundle
